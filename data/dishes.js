...
const DISHES = [
  ...
  },
  {
    ...
    emoji: "🍖",
    category: "hot",
    desc: "我做的：排骨炖到一抿脱骨，蒜瓣比肉还抢手，红油汤汁拌两碗饭都不够",
    tags: ["招牌", "下饭", "麻辣"],
    spicy: 2,
    minutes: 25,
    level: 2,
    ingredients: [
      "猪小排 700g（剁成 3cm 寸段，让摊主剁好）",
      "大蒜 2 整头（剥成整瓣，图上蒜多是有道理的）",
      "姜 1 大块（一半拍碎焯水、一半切片）",
      "干辣椒 8 个 + 辣椒碎 1 小把",
      "花椒 1 小把",
      "八角 2 颗、桂皮 1 小段",
      ...
      "生抽 2 勺、老抽 半勺",
      "料酒 2 勺",
      "白胡椒粉 少许、熟白芝麻 一小撮（出锅撒）"
    ],
    steps: [
      "排骨冷水下锅，加姜块和 1 勺料酒，大火烧开撇净血沫，煮 3 分钟捞出，用温水冲净（冲冷水肉会紧）。",
      "锅里少油，下冰糖 8 粒小火熬到枣红冒小泡，立刻倒排骨翻炒上色。要点：看到起泡就下肉，糖色一焦整锅发苦。",
      "排骨裹匀糖色后，下豆瓣酱、辣椒碎、花椒、八角桂皮，小火炒出红油和香味。",
      "加生抽 2 勺、老抽半勺、料酒 1 勺翻匀，倒热水没过排骨。",
      "大火烧开转小火盖盖炖 30 分钟，中途丢一半蒜瓣进去一起炖，蒜香能进汤里。",
      "最后 8 分钟下剩下的蒜瓣和整颗干辣椒，开中火收汁，收到汤汁能挂住排骨就停——留一点拌饭，别收干。",
      "出锅前撒白胡椒粉翻匀，装盘撒白芝麻，趁热上桌（凉了油会凝，味道差一半）。"
    ]
  },
  {
    id: "jichi-daxia-bao",
    ...
    emoji: "🍲",
    category: "hot",
    desc: "我做的：鸡翅滑、虾鲜甜，玉米吸饱了汁，最后连汤都被她拿去拌饭",
    tags: ["招牌", "硬菜", "下饭"],
    spicy: 2,
    minutes: 40,
    level: 2,
    ingredients: [
      "鸡中翅 10 个（两面各划两刀，好入味）",
      "大虾 12 只（剪掉虾枪长须，开背去虾线）",
      "甜玉米 1 根（切厚圆片，别切太薄，炖久了会散）",
      "青椒 3 个、红椒 1 个（切块，最后才下）",
      "香肠 / 火腿肠 2 根（斜刀切片）",
      "土豆 1 个（切厚片垫底，防糊还吸汁）",
      "洋葱 半个（切块垫底，出甜味）",
      "蒜 1 整头、姜 1 大块（蒜整瓣、姜切片）",
      "干辣椒 6 个、花椒 1 小把（不吃辣就减半）",
      "郫县豆瓣酱 1 大勺、生抽 2 勺、老抽 半勺、蚝油 1 勺",
      "啤酒 1 罐（没有就用热水 500ml）、冰糖 5 粒、白胡椒粉 少许"
    ],
    steps: [
      "鸡翅冷水下锅，加姜片和料酒焯 3 分钟，撇净浮沫捞出擦干；虾开背去虾线。",
      "锅里少油，鸡翅中小火煎到两面金黄盛出。要点：鸡翅一定擦干再下锅，带水只会溅油、煎不出焦香。",
      "底油下姜蒜、干辣椒、花椒炒香，加豆瓣酱炒出红油。",
      "倒回鸡翅，加生抽、老抽、蚝油、冰糖翻炒上色，倒啤酒没过食材。",
      "铺上土豆片和玉米段，大火烧开转小火盖盖焖 15 分钟，中途别翻，让土豆在底下吸味。",
      "开盖下虾、香肠片和青红椒，中火再煮 5 分钟。要点：虾一变红打卷就停，煮久了肉柴。",
      "汤汁收到能挂住勺子就关火，撒白胡椒粉，整锅端上桌 —— 凉了虾会腥。"
    ]
  },
  {
    id: "fanqie-chaodan",
